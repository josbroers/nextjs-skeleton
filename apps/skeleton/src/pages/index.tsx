...
const Home = () => {
	const title = "Next.js Skeleton: ESLint, Husky, Prettier, Sass, TypeScript and much more!";
	const description = "A simple and highly customizable skeleton build with Turborepo and Next.js. Featuring ESLint, Husky, Prettier, Sass, TypeScript and much more!";
